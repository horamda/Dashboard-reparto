...
<title>Actualizar dashboard</title><link rel="icon" type="image/png" href="/static/logot2.png">
...
<meta name=viewport content="width=device-width,initial-scale=1">
<title>Ingresar</title><link rel="icon" type="image/png" href="/static/logot2.png">
<style>*{{box-sizing:border-box;letter-spacing:0}}body{{font-family:system-ui,Segoe UI,Arial,sans-serif;background:#EEF1F5;color:#15233B;margin:0;line-height:1.45;-webkit-font-smoothing:antialiased}}
...
<body><div class=box>
<img class=login-logo src="/static/logot2.png" alt="T2">
<h1>Ingresar</h1>
...
<meta name=viewport content="width=device-width,initial-scale=1"><title>Dashboard de reparto</title><link rel="icon" type="image/png" href="/static/logot2.png">
...
<body><div class=box><img class=landing-logo src="/static/logot2.png" alt="T2"><h1>Todavía no hay datos cargados</h1>
...
def _data_unavailable_page(title, exc):
    ...
    return f'''<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>{escape(title)}</title><link rel="icon" type="image/png" href="/static/logot2.png">
...
def _main_page():
    ...
    return f'''<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Panel principal</title><link rel="icon" type="image/png" href="/static/logot2.png">
...
<body><div class=wrap><div class=top><div class=brand-title><img class=brand-logo src="/static/logot2.png" alt="T2"><div><h1>Panel principal</h1><p class=muted>Del Palacio S.A. - módulos de reparto, Foxtrot, FichaYA y pedidos.</p></div></div><div class=nav><a href="/dashboard">Dashboard</a><a href="/pedidos">Pedidos</a><a href="/logout">Cerrar sesión</a></div></div>{content}</div></body></html>'''
...
<td><form id="{escape(form_id)}" method=post action="/foxtrot-calidad/guardar"><input type=hidden name=rid value="{escape(str(rid))}"><button class=btn type=submit>Guardar</button></form></td>
    ...
    return f"""<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Calidad Foxtrot</title><link rel="icon" type="image/png" href="/static/logot2.png">{DATOS_CSS}
<style>
...
<body><div class=wrap><div class=top><div class=brand-title><img class=brand-logo src="/static/logot2.png" alt="T2"><div><h1>Calidad de columnas Foxtrot</h1><p class=muted>Filtrá campos vacíos/con dato y completá valores faltantes por ruta. Al guardar se recalculan inicio, fin, horas y dispersiones si aplica.</p></div></div>
...
def _fichaya_report_page():
    ...
    if warning:
        ...
        alert = ""
    return f"""<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Reporte FichaYA Foxtrot</title><link rel="icon" type="image/png" href="/static/logot2.png">{DATOS_CSS}
<style>
...
<body><div class="wrap report-wrap"><div class=top><div class=brand-title><img class=brand-logo src="/static/logot2.png" alt="T2"><div><h1>Reporte FichaYA + Foxtrot</h1><p class=muted>Desde agosto 2026. TML = inicio Foxtrot - fichada ingreso. TI = fichada salida - finalización Foxtrot.</p></div></div>
<div class=nav><a class=secondary href="/inicio">Inicio</a><a class=secondary href="/dashboard">Dashboard</a><a class=secondary href="/pedidos">Pedidos</a><a class=secondary href="/costos-distribucion/dashboard">Costos</a><a class=secondary href="/datos">Datos</a><a class=secondary href="/admin">Admin</a><a href="/logout">Salir</a></div></div>{alert}
...
{hidden}<button class="btn danger" type=submit>Restablecer origen</button></form>"""
    ...
    return f"""<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Editar registro FichaYA</title><link rel="icon" type="image/png" href="/static/logot2.png">{DATOS_CSS}
...
<body><div class=wrap><div class=top><div class=brand-title><img class=brand-logo src="/static/logot2.png" alt="T2"><div><h1>Editar registro</h1><p class=muted>Reporte FichaYA + Foxtrot</p></div></div><div class=nav><a class=secondary href="{escape(back_url, quote=True)}">Volver al reporte</a><a href="/logout">Salir</a></div></div>{alert}
...
<title>Costos de distribución</title><link rel="icon" type="image/png" href="/static/logot2.png"><link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" crossorigin=""><style>
...
def _logistics_dashboard_page():
    ...
    return f'''<!doctype html><html lang=es><head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Dashboard de costos</title><link rel="icon" type="image/png" href="/static/logot2.png"><style>
